 ...
 */
package util.android.customdialog;
...
public class CustomDialogBuilder extends AlertDialog.Builder {
	...
	public CustomDialogBuilder setDividerColour(int colorRes) {
		mDivider.setBackgroundColor(context.getResources().getColor(colorRes));
		return this;
	}
	...
	/**
	 * This allows you to specify a custom layout for the area below the title divider bar in the dialog. As an example
	 * you can look at example_ip_address_layout.xml and how I added it in TestDialogActivity.java
	 * 
	 * @param resId
	...
	public AlertDialog show() {
		...
		try {
			alert.getButton(DialogInterface.BUTTON_NEGATIVE).requestFocus();
			// alert.findViewById(android.R.id.button1).requestFocus();
		} catch (Exception e1) {
		...
		if (button_background != 0) {
			try {
				((Button) alert.findViewById(android.R.id.button1)).setBackgroundResource(button_background);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			try {
				((Button) alert.findViewById(android.R.id.button2)).setBackgroundResource(button_background);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			try {
				((Button) alert.findViewById(android.R.id.button3)).setBackgroundResource(button_background);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
